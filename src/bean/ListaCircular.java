 ...
 * @param <Object>
 */
public class ListaCircular<Object> implements Lista<Object> {
    ...
    public void adicionar(Object o) {
        if (this.elemento == null) {
            ...
            this.primeiroElemento.setAnterior(this.elemento);
            this.primeiroElemento.setProximo(this.elemento);
            this.quantidade++;
            return;
        }
        if (this.elemento != null) {
            NoDuploEncadeado elemento = new NoDuploEncadeado(o, this.primeiroElemento, this.elemento);
        ...
        for (int i = 0; i < this.quantidade; i++) {
            if (idx.equals(i)) {
                if (elemento.equals(this.primeiroElemento)) {
                    ...
                    NoDuploEncadeado novoElemento = new NoDuploEncadeado(o, auxiliar, this.elemento);
                    auxiliar.setAnterior(novoElemento);
                    this.primeiroElemento = novoElemento;
                    this.elemento.setProximo(this.primeiroElemento);
                    this.quantidade++;
                    return;
                }
                NoDuploEncadeado auxiliar = elemento;
...
//            NoEncadeado elemento = new NoEncadeado(o, this.primeiroElemento, this.elemento);
//            this.elemento.setProximo(elemento);
//            this.elemento = elemento;
