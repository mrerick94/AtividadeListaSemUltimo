 ...
 * @author erick
 */
public class PilhaSemUltimo<Object> implements Lista<Object>  {
    
    public PilhaSemUltimo() {
        this.quantidade = 0;
    }
    ...
    public void adicionar(Object o) {
        ...
        if (this.primeiroElemento != null) {
            NoDuploEncadeado elemento = new NoDuploEncadeado(o, this.primeiroElemento, null);
    ...
    public Object remover() {
        ...
        Object elementoARemover = (Object) this.primeiroElemento.getElemento();
        if (this.primeiroElemento.getProximo() != null) {
